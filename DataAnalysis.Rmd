...
ggsave(file="figures/FigS2_raw_K_country_O.pdf", width=9, height=11)
ggsave(file="figures/FigS2_raw_K_country_O.png", width=9, height=11)
```


# Fig S3 - temporal spread of K/O types per site
``` {r}
...
ggsave(file="figures/FigS3_clones_site_year.pdf", width=9, height=12)
ggsave(file="figures/FigS3_clones_site_year.png", width=9, height=12)
```
...
ggsave(file="figures/FigS16_ClusterDaysThreshold.pdf", width=9, height=12)
ggsave(file="figures/FigS16_ClusterDaysThreshold.png", width=9, height=12)
...
ggsave(file="figures/FigS17_ClusterSNPsThreshold.pdf", width=9, height=12)
ggsave(file="figures/FigS17_ClusterSNPsThreshold.png", width=9, height=12)
